...
import { CubeIcon as Package, Squares2X2Icon as Layers, CheckCircleIcon as CheckCircle } from '@heroicons/react/24/outline';
      ...
      <div className="grid grid-cols-2 gap-3">
        {typeOptions.map((option) => {
          ...
          return (
            ...
            >
              <Icon 
                className={`w-8 h-8 ${isSelected ? 'text-primary-600' : 'text-gray-400'}`}
              />
