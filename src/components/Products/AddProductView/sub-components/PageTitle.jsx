 ...
 * - Main title (required) - can be string or ReactNode
 * - Optional subtitle/description - can be string or ReactNode
 * - Single or multiple action buttons/links - auto-wraps when needed
 * - Customizable layout and styling
 * - RTL support with configurable alignment
 * - Responsive design with proper flex behavior
