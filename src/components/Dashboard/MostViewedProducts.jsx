...
/**
 * MostViewedProducts Component (Top Sellers)
 * 
 * Displays top selling products based on REAL WooCommerce API data (reports/top_sellers or total_sales).
 * 
 * @param {Array} products - Array of product objects with sales data from API
 * @param {Function} formatCurrency - Function to format currency values
 * @param {Function} t - Translation function
 * @param {boolean} isRTL - Whether the layout is right-to-left
 */
const MostViewedProducts = ({ products, formatCurrency, t, isRTL }) => {
  ...
  return (
    <div className="space-y-3">
      {products.map((product, index) => {
        ...
        const soldCount = product.sold_quantity || product.total_sales || 0;
