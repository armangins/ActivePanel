...
const MarginSelector = ({ value, onChange, error }) => {
  ...
  return (
    <div>
      <label htmlFor="desired-margin" className="block text-sm font-medium text-gray-700 mb-2 text-right flex items-center gap-2">
      ...
      <div className="grid grid-cols-4 gap-3" role="group" aria-labelledby="desired-margin">
        {margins.map((margin) => (
          <button
            ...
            className={`p-4 border-2 rounded-lg transition-all flex items-center justify-center gap-2 ${
