...
import { Card, Form, InputNumber, Row, Col, Typography, theme } from 'antd';
            ...
            <Card title={t('pricing') || 'Pricing'} variant="borderless" className="details-card">
                {productType === 'variable' ? (
                    <div style={{ textAlign: 'center', padding: '24px 0', color: '#666' }}>
                        <Text type="secondary">
                            {t('variablePricingNotice') || 'This product has variations. Manage prices and stock in the "Variations" section.'}
                        </Text>
                    </div>
                ) : (
                    <>
                        ...
                        <Form.Item label={t('costPerItem') || 'Cost per item'} help="Customers won't see this">
                            <InputNumber
                                value={cost}
                                disabled
                                style={{ width: '100%' }}
