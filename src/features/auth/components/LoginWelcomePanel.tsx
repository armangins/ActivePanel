 ...
 */
export const LoginWelcomePanel = () => {
    ...
    return (
        <div style={{
            ...
            <div style={{
                ...
                width: 'fit-content',
                textAlign: 'right',
                marginLeft: 'auto' // Align to right in LTR? Or Flex-end handles it?
            }}>
                {/* Logo */}
                ...
                {/* Description */}
                <Text style={{ fontSize: 16, color: 'rgba(255, 255, 255, 0.8)', lineHeight: 1.6, maxWidth: 400 }}>
                    Active Panel
                    <br />
                    פלטפורמת ניהול החנויות המובילה, הצטרפו למאות עסקים שכבר בחרו נכון
                </Text>

                {/* Dark Mode Toggle Placeholder - functionality typically relies on global context not migrated yet */}
